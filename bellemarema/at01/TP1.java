...
public class TP1 {
    ...
    public static void main(String[] args) {
        ...
        int randomNum = (int) (Math.random() * 21)+1; // 0 a 20
        ...
        if (choix == 1) {
           ...
           System.out.println("Vous avez choisi le choix 2 : trouver le nombre mystère");
            do{ 
                ...
                System.out.println(" il vous reste "+NbrChance +" chance pour trouver le nombre");
                    ...
                    System.out.println("Bravo vous avez trouver le nombre aléatoire");
                }

            } while (NumUtilisateur != randomNum && NbrChance>0);
            if (NumUtilisateur != randomNum && NbrChance==0) {
                System.out.println("Vous n'avez pas réussit a trouver le nombre aléatoire");
                System.out.println("Le nombre aléatoire était : " + randomNum);
            }
